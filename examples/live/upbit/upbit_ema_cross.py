...
strat_config = EMACrossConfig(
    instrument_id=InstrumentId.from_str("KRW-ETH.UPBIT"),
    external_order_claims=[InstrumentId.from_str("KRW-ETH.UPBIT")],
    bar_type=BarType.from_str("KRW-ETH.UPBIT-1-MINUTE-LAST-EXTERNAL"),
    fast_ema_period=10,
    slow_ema_period=20,
